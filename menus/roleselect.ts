...
const role_dict:{[key: string]: string[]} = {
    "OS": [ "os/Gentoo", "os/iOS", "os/Android","os/Trisquel", "os/Debian", "os/ZorinOS","os/Mint" ,"os/Pop!_OS" , "os/Fedora","os/Ubuntu", "os/Arch", "os/nixOS", "os/macOS", "os/Windows10", "os/Windows11", "os/FreeBSD", "os/NetBSD", "os/Void", "os/CachyOS", "os/Bazzite"],
    "DE (or WM)": ["de/GNOME", "de/KDE", "de/XFCE", "de/CDE", "de/Cinnamon", "wm/i3", "wm/Hyprland", "wm/Niri"],
